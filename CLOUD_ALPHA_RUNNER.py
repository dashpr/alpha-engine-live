...
# NOTE: In cloud demo we simulate tickers list.
TICKERS = [
...
# ---------------- SIMPLE QUALITY PLACEHOLDER ----------------
def dummy_quality(prices):
    # equal neutral quality for cloud demo
...
def main():
    ...
    dashboard = {
        ...
        "nifty_values": nifty["Close"].reindex(equity.index).fillna(method="ffill").tail(200).round(2).tolist(),
